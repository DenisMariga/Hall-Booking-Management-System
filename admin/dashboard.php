          ...
          <div class="row">
            ...
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-info card-img-holder text-white"style="height: 150px;">
                <div class="card-body">
                  <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                  <h4 class="font-weight-normal mb-3">Total Halls <i class="mdi mdi-bank mdi-24px float-right"></i>
                  </h4>
                  <?php 
                  ...
                  $query->execute();
                  $results=$query->fetchAll(PDO::FETCH_OBJ);
                  $totalrooms=$query->rowCount();
                  ?>
                  <h2 class="mb-5"><?php echo htmlentities($totalrooms);?></h2>
                </div>
              </div>
            </div>
            <div class="col-md-4 stretch-card grid-margin">
              <div class="card bg-gradient-success card-img-holder text-white"style="height: 150px;">
                <div class="card-body">
                  <img src="assets/images/dashboard/circle.svg" class="card-img-absolute" alt="circle-image" />
                  <h4 class="font-weight-normal mb-3">Total Descriptions <i class="mdi mdi-book mdi-24px float-right"></i>
                  </h4>
                  <?php 
                  ...
                  $query->execute();
                  $results=$query->fetchAll(PDO::FETCH_OBJ);
                  $totalcourses=$query->rowCount();
                  ?>
                  <h2 class="mb-5"><?php echo htmlentities($totalcourses);?></h2>
                </div>
              </div>
            </div>
          </div>
