            ...
            <div class="col-lg-12 grid-margin stretch-card">
              <div class="card">
               <div class="modal-header">
                <h5 class="modal-title" style="float: left;">Hall Use Description</h5>
              </div>
                ...
                <form class="forms-sample" method="post" enctype="multipart/form-data" class="form-horizontal">
                  ...
                  <div class="row ">
                    <div class="form-group col-md-12">
                      <label for="exampleInputName1">Event(Eg graduation, meeting)</label>
                      <input type="text" name="short" value="" class="form-control" id="short"required>
                    </div>
                    <div class="form-group col-md-12">
                      <label for="exampleInputName1">Briefly Describe</label>
                      <input type="description" name="full" value="" class="form-control" id="full"required>
                    </div>
                  </div>
            ...
            <div class="card">
              ...
              <div id="editData5" class="modal fade">
                <div class="modal-dialog modal-md">
                  <div class="modal-content">
                    <div class="modal-header">
                      <h5 class="modal-title">View description details</h5>
                      <button type="button" class="close" data-dismiss="modal" aria-label="Close">
                        <span aria-hidden="true">&times;</span>
                      </button>
                    </div>
