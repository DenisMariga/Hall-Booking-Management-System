    ...
    <ul class="nav">
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="ui-basic">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="manage_desc.php">Descriptions</a></li>
                    <li class="nav-item"> <a class="nav-link" href="manage_halls.php">Manage Halls</a></li>
                </ul>
            </div>
        </li>
        ...
        <li class="nav-item">
            ...
            <div class="collapse" id="companymanagement">
                <ul class="nav flex-column sub-menu">
                    <li class="nav-item"> <a class="nav-link" href="companyprofile.php">Hotel profile </a></li>
                </ul>
            </div>
        </li>
