            ...
            <form class="form-sample"  method="post" enctype="multipart/form-data">
                <div class="row">
                    <div class="form-group col-md-12">
                        <label class="col-sm-12 pl-0 pr-0">No of People</label>
                ...
                <div class="row">
                    <div class="form-group col-md-12 ">
                        <label class="col-sm-12 pl-0 pr-0">Hall No.</label>
                        <div class="col-sm-12 pl-0 pr-0">
                            <input type="text" name="number" value="<?php  echo $row->room_no;?>" class="form-control" disabled>
                            <span class="help-block m-b-none">Hall no can't be changed.</span>
                        </div>
                    </div>
                </div>
                <div class="row">
                    <div class="form-group col-md-12 ">
                        <label class="col-sm-12 pl-0 pr-0">Fee(Per Number)</label>
                        <div class="col-sm-12 pl-0 pr-0">
