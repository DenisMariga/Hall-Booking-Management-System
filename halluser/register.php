                        ...
                        <div class="auth-form-light text-left p-5">
                            ...
                            <form class="pt-3" method="post" enctype="multipart/form-data" name="signup" onSubmit="return valid();">
                                <div class="form-group mb-3" >
                                    <input type="text" class="form-control form-control-lg" name="regnumber" id="regnumber" onBlur="checkAvailability2()" placeholder="Identification No" required style="height: 2.0rem;">
