...
$ppincode=$_POST['ppincode'];
  ...
  if ($LastInsertId>0) 
  {
    ...
    echo "<script>window.location.href ='bookhall.php'</script>";
  }
  else
  {
...
<head>
  ...
  <title>Hall Booking Management System</title>
  <!-- plugins:css -->
            ...
            <div class="col-12">
              <div class="card">
                <div class="modal-header">
                  <h5 class="modal-title" style="float: left;">Book Hall </h5>
                </div>
                          ...
                          <div class="panel-body">
                            <form method="post" action="" class="form-horizontal">
                              <div class="form-group">
                                <label class="col-sm-4 control-label"><h4 style="color: green" align="left">Hall Related info </h4> </label>
                              </div>
                              <div class="row">
                                ...
                                <div class="form-group col-md-4">
                                  <label class="control-label">Fees Per Event</label>
                                  <div class="">
                              ...
                              <div class="form-group">
                                ...
                                <div class="col-sm-12">
                                <input type="radio" value="0" name="foodstatus" checked="checked"> Without Equipment
                                  <input type="radio" value="1" name="foodstatus"> With Equipment(2000.00 Per Event )
                                </div>
                              </div>  
                              <div class="row">
                              ...
                              <div class="row">
                                <div class="form-group col-md-4">
                                  ...
                                  <div class="form-group col-md-4">
                                    <label class=" control-label">Identification No/Passport Number: </label>
                                    <div class="">
                                ...
                                <div class="row">
                                  ...
                                  <div class="form-group col-md-4">
                                  <label class=" control-label">Other Contact(any other group member): </label>
                                    <div class="">
